...
const RegistrationCityScreen: React.FC = () => {
  ...
  const handleContinue = () => {
    if (selectedCity) {
      router.push('/registration-data' as any);
    }
  };
      ...
      >
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.citySelectionContainer}>
              ...
              <View style={styles.dropdownContainer}>
                {filteredCities.map((city) => (
                  ...
                  >
                    ...
                    <Text style={styles.dropdownItemRegion}>
                      {city.region}
                    </Text>
                  </TouchableOpacity>
                ))}
            ...
            {/* Кнопка показать dropdown */}
            {!showDropdown && (
              <TouchableOpacity
                style={styles.showDropdownButton}
                onPress={() => setShowDropdown(true)}
              >
                <Text style={styles.showDropdownText}>Выбрать город</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
